...
cards.forEach(memoryCard => memoryCard.addEventListener("click", ()  => { // anonymous function 
    ...
    if (!cardOne) {
      ...
      cardTwo = memoryCard;
      if (cardOne.childNodes[3].classList[1] === cardTwo.childNodes[3].classList[1]) {
        console.log("WOW you picked two cards next to each other, congrats, are you proud?");    // if cardOne class === cardTwo class log yay and move to next
...
// --------------- ^^^^working^^^^ ------------------ //
  ...
  // .childNodes[3].classList[1]
    // console.log(memoryCard.childNodes[3].classList[1]);
    // } else {
    //   if (cardOne === cardTwo) {
    //     console.log("yay");
    //     cardOne = "";
...
//     if (cardOne === "") {
//       cardOne = memoryCard.childNodes[3].classList[1]
//       ;
//     } 
//     else if (cardTwo === "") {
//     cardTwo = memoryCard.childNodes[3].classList[1]
